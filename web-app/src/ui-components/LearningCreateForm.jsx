...
import { createLearning } from "../graphql/mutations";
export default function LearningCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const [clonedFromID, setClonedFromID] = React.useState(
    initialValues.clonedFromID
  );
  ...
  const resetStateValues = () => {
    setOrderIndex(initialValues.orderIndex);
    setTitle(initialValues.title);
    setDescription(initialValues.description);
    setQuizScore(initialValues.quizScore);
    setQuizStatementsCount(initialValues.quizStatementsCount);
    setHasQuizTaken(initialValues.hasQuizTaken);
    setIsDefault(initialValues.isDefault);
    setReadTime(initialValues.readTime);
    setClonedFromID(initialValues.clonedFromID);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createLearning.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LearningCreateForm")}
      {...rest}
    >
      <TextField
        label="Order index"
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.clonedFromID ?? value;
          }
          if (errors.clonedFromID?.hasError) {
            runValidationTasks("clonedFromID", value);
          }
          setClonedFromID(value);
        }}
        onBlur={() => runValidationTasks("clonedFromID", clonedFromID)}
        errorMessage={errors.clonedFromID?.errorMessage}
        hasError={errors.clonedFromID?.hasError}
        {...getOverrideProps(overrides, "clonedFromID")}
      ></TextField>
      <TextField
        label="Created at"
        isRequired={false}
