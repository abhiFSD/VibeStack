...
import { createSectionInteraction } from "../graphql/mutations";
export default function SectionInteractionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setChapterID(initialValues.chapterID);
    setSectionID(initialValues.sectionID);
    setTimeSpent(initialValues.timeSpent);
    setViewCount(initialValues.viewCount);
    setLastViewedAt(initialValues.lastViewedAt);
    setFirstViewedAt(initialValues.firstViewedAt);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createSectionInteraction.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SectionInteractionCreateForm")}
      {...rest}
    >
      <TextField
        label="User sub"
