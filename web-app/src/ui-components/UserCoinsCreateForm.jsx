...
import { createUserCoins } from "../graphql/mutations";
export default function UserCoinsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTotal_coins(initialValues.total_coins);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createUserCoins.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserCoinsCreateForm")}
      {...rest}
    >
      <TextField
        label="User sub"
