...
import { createActionItems } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function ActionItemsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAssignor(initialValues.assignor);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createActionItems.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ActionItemsCreateForm")}
      {...rest}
    >
      <SwitchField
        label="Note"
