...
import { createAwardDefinition } from "../graphql/mutations";
export default function AwardDefinitionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createAwardDefinition.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AwardDefinitionCreateForm")}
      {...rest}
    >
      <SelectField
        label="Type"
