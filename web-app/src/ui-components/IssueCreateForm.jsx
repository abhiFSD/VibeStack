...
export default function IssueCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setReporterEmail(initialValues.reporterEmail);
    setReporterName(initialValues.reporterName);
    setReporterID(initialValues.reporterID);
    setOrganizationID(initialValues.organizationID);
    setAssignedToEmail(initialValues.assignedToEmail);
    setAssignedToName(initialValues.assignedToName);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createIssue.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "IssueCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
