...
export default function OrganizationUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAdditionalOwners(cleanValues.additionalOwners ?? []);
    ...
    setLeaderboardEnabled(cleanValues.leaderboardEnabled);
    setStripeCustomerId(cleanValues.stripeCustomerId);
    setStripeSubscriptionId(cleanValues.stripeSubscriptionId);
    setStripeSubscriptionItemId(cleanValues.stripeSubscriptionItemId);
    setSubscriptionStatus(cleanValues.subscriptionStatus);
    setSubscriptionPeriodEnd(cleanValues.subscriptionPeriodEnd);
    setBillingPeriod(cleanValues.billingPeriod);
    setActiveUserCount(cleanValues.activeUserCount);
    setPurchasedLicenses(cleanValues.purchasedLicenses);
    setAiDisabledUsers(cleanValues.aiDisabledUsers ?? []);
    setCurrentAiDisabledUsersValue("");
    setLearningCoinsPerInterval(cleanValues.learningCoinsPerInterval);
    setLearningCoinInterval(cleanValues.learningCoinInterval);
    setLearningMaxCoinsPerSession(cleanValues.learningMaxCoinsPerSession);
    setLearningCoinsEnabled(cleanValues.learningCoinsEnabled);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          leaderboardEnabled: leaderboardEnabled ?? null,
          ...
          purchasedLicenses: purchasedLicenses ?? null,
          aiDisabledUsers: aiDisabledUsers ?? null,
          learningCoinsPerInterval: learningCoinsPerInterval ?? null,
          learningCoinInterval: learningCoinInterval ?? null,
          learningMaxCoinsPerSession: learningMaxCoinsPerSession ?? null,
          learningCoinsEnabled: learningCoinsEnabled ?? null,
