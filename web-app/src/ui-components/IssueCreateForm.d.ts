...
export declare type IssueCreateFormInputValues = {
    title?: string;
    description?: string;
    category?: string;
    priority?: string;
...
export declare type IssueCreateFormValidationValues = {
...
export declare type IssueCreateFormOverridesProps = {
    IssueCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type IssueCreateFormProps = React.PropsWithChildren<{
    overrides?: IssueCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: IssueCreateFormInputValues) => IssueCreateFormInputValues;
    onSuccess?: (fields: IssueCreateFormInputValues) => void;
    onError?: (fields: IssueCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: IssueCreateFormInputValues) => IssueCreateFormInputValues;
    onValidate?: IssueCreateFormValidationValues;
} & React.CSSProperties>;
export default function IssueCreateForm(props: IssueCreateFormProps): React.ReactElement;
