...
import { createQuizzesResult } from "../graphql/mutations";
export default function QuizzesResultCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createQuizzesResult.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "QuizzesResultCreateForm")}
      {...rest}
    >
      <TextField
        label="Correct"
